...
const {
  data: ListFile,
  refresh: ListFileRefresh,
} = await useFetch("/api/storage", {
...
<template>
  ...
  <button class="btn btn-success" @click="onCreateNewFIleOpen">
    สร้างไฟล์ใหม่
  </button>
  <div class="table-responsive">
    <table class="table table-hover mt-4 mb-5">
      ...
      <tbody>
        <tr v-for="(file, index) in ListFile.data">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5 sarabun-extrabold" id="createFileModal">
            สร้างไฟล์ใหม่
          </h1>
          <button
            type="button"
        ...
        <div class="modal-body">
          <div
            ...
            role="alert"
            v-show="onCreateNewFIleErrorMessage"
          >
